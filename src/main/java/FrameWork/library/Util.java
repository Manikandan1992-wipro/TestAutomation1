...
/*			Set<String> newwindows = driver.getWindowHandles();
	...
	public static WebDriver getLatestwindow() {
		WebDriver driver = po_BaseClass.po_GetDriver();
		String CurWindow = null;
...
//			if (i == 30) {
	...
	public static void clickWithTableText2(int clickCol, String xPathString) throws Exception {
		waitForPageLoad();

		click(getLatestDriver().findElement(By.xpath("//div[@class='x-window-bwrap']//div[@class='x-grid3-body']/table/tbody/tr/td["+clickCol+ "]/div[contains(text(),'"+xPathString+"')]")));
